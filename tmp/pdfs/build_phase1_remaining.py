...
('2. Restore production domains and market routing','COMPLETE','Client/domain owner plus engineering','Completed 29 July 2026. The client purchased usemewithstyle.shop and the production storefront and CMS hosts were attached to Vercel and Railway.',[
'Published apex, www, ao, and pt records for Vercel and attached all four hosts to the production storefront project.','Published the Railway CNAME and ownership-verification records for cms.usemewithstyle.shop.','Updated the production storefront environment, domain checker, routing tests, documentation, and customer-facing fallback links from the unavailable .com domain to .shop.','Verified apex, AO, and PT storefront responses over HTTPS; remaining certificate/DNS propagation checks are part of launch QA.','Routing unit tests and the production build pass on commit 01e1c95.'],['Re-run the domain checker during final production QA after global DNS caches and certificates fully settle.','Verify geo-routing, deep-link switching, Admin/API access, canonical metadata, and payment return URLs on the final hosts.']),
