...
story = [Spacer(1, 18*mm), p('USE ME WITH STYLE', 'Subtitle'), p('Phase 1 Remaining Delivery Report', 'TitleBrand'),
         ...
         p('<b>Current assessment - 3 of 13 delivery workstreams complete</b><br/>The CMS production deployment, durable production media storage, and Phase 1 delivery/fulfilment rules are implemented and verified. Phase 1 is not ready for final client delivery because the public custom domain has not been purchased, the final catalogue is unavailable, and live payment, messaging, email, legal, production-QA, and client-acceptance work remains.', 'Callout')]
