...
story = [Spacer(1, 18*mm), p('USE ME WITH STYLE', 'Subtitle'), p('Phase 1 Remaining Delivery Report', 'TitleBrand'),
         ...
         p('<b>Current assessment - 4 of 13 delivery workstreams complete</b><br/>The CMS production deployment, production domains and market routing, durable media storage, and Phase 1 delivery/fulfilment rules are implemented. Transactional email is configured and delivery-tested, with controlled PT/EN order tests still outstanding. Phase 1 is not ready for final client delivery because the final catalogue, live payments, messaging, remaining legal details, production QA, and client acceptance are still outstanding.', 'Callout')]
...
summary = [
    ...
    ['P1', 'Transactional email', 'Resend live; support delivery verified; PT/EN order tests remain'],
...
('8. Configure transactional email','IN PROGRESS','Client/domain owner plus engineering','Resend and the client-owned mailboxes are live. The production contact-form path was delivered successfully; controlled order-confirmation tests remain.',[
'Completed: verified usemewithstyle.shop in Resend with DKIM, SPF, DMARC, and the isolated send subdomain while preserving Namecheap Private Email MX delivery.','Completed: created a domain-scoped sending-only production API key and deployed the orders@ sender, support@ contact destination, sender name, and final public-site URL to Railway.','Completed: submitted the production CMS contact endpoint and confirmed Resend delivered the message to support@usemewithstyle.shop.','Completed: updated CMS fallback addresses and links to .shop; 20 tests, lint, and production build pass on commit e6b6368.','Pending: run controlled PT and EN paid-order confirmations, verify invoice attachment and order-lookup link, inspect mailbox/spam placement, and confirm failure logging.'],['Controlled PT and EN production orders receive the correct email and invoice attachment.','Support and order mailboxes are monitored and the operational owner is documented.']),
