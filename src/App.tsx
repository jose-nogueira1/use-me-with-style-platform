...
${Object.entries(DARK_VARS).map(([k, v]) => `          ${k}: ${v};`).join('\n')}
        ...
        * { box-sizing: border-box; }
        ...
        @media (min-width: 1400px) {
          .ump-footer-grid { max-width: none; margin: 0; padding-left: 32px; padding-right: 32px; grid-template-columns: 1.3fr 4fr; }
          .ump-footer-links-grid { grid-template-columns: repeat(4, 1fr); }
        }
        ...
        .ump-home-product-grid { grid-template-columns: repeat(auto-fill, minmax(min(258.75px, 100%), 1fr)); }
