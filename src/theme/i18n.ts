...
export const T: Record<string, Record<Lang, string>> = {
  ...
  availableOnly: { pt: 'Apenas disponíveis', en: 'Available only' },
  priceRange: { pt: 'Intervalo de preço', en: 'Price range' },
  minPrice: { pt: 'Mínimo', en: 'Minimum' },
  maxPrice: { pt: 'Máximo', en: 'Maximum' },
  onSale: { pt: 'Em promoção', en: 'On sale' },
  productType: { pt: 'Tipo de produto', en: 'Product type' },
  productTypeStandard: { pt: 'Produto', en: 'Product' },
  productTypeBundle: { pt: 'Conjunto', en: 'Set' },
  ...
  deliveryCtt: { pt: 'CTT Standard — sem rastreio', en: 'CTT Standard — untracked' },
  deliveryCourier: { pt: 'CTT Registado — com rastreio', en: 'CTT Registered — tracked' },
  ...
  trackWithCtt: { pt: 'Acompanhar nos CTT', en: 'Track with CTT' },
