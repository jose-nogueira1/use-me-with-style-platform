...
// Homepage "Instagram feed" section (2026-07-10 addition). Static curated
// grid, not a live Graph API embed -- that would need a Meta app + an
// Instagram Business account linked to a Facebook Page, similar setup weight
// to the still-pending WhatsApp/messaging credentials (see
// useme-messaging-foundation memory). The client confirmed the account as
    ...
    <div className="ump-content-width" style={{ padding: '28px 20px 40px' }}>
      ...
      <div className="ump-instagram-grid">
        {Array.from({ length: TILE_COUNT }).map((_, i) => (
          ...
          >
            <ProductPhoto tone={TONE_CYCLE[i % TONE_CYCLE.length]} radius={8} />
            <div
