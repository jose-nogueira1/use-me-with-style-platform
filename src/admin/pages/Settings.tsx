import { HeroImagePositionEditor } from '../components/HeroImagePositionEditor';
...
function HomeHeroSection() {
  ...
  const handleSave = async () => {
    ...
    setSaved(false);
    try {
      let heroImageId: string | number | null = refId(content.heroImage) || null;
      let heroImageMobileId: string | number | null = refId(content.heroImageMobile) || null;
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 16 }} className="ump-admin-orders-grid">
            ...
            <div>
              ...
              <HeroImagePositionEditor content={content} setContent={setContent} saving={saving} lang={lang} heroImageUrl={heroImageUrl} />
              {heroImageUrl ? (
                <div style={{ marginBottom: 10 }}>
                  <button
                    onClick={() => {
...
function InstagramSpotlightSection() {
  ...
  const associationItemCount = (association: ShopAssociation | null) =>
    (association?.products ?? []).reduce<number>((total, product) => {
